...
def _run_script(path: Path, monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("mod_04_smallestOfThree", str(path))
...
def test_smallest_value(monkeypatch):
    path = Path(__file__).resolve().parent / "04_smallestOfThree.py"
