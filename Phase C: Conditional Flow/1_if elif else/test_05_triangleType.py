...
def _run_script(path: Path, monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("mod_05_triangleType", str(path))
...
def test_triangle_type(monkeypatch):
    path = Path(__file__).resolve().parent / "05_triangleType.py"
