...
def _run_script(path: Path, monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("mod_03_letterGrade", str(path))
...
def test_letter_grade(monkeypatch):
    path = Path(__file__).resolve().parent / "03_letterGrade.py"
